    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="show_user.php"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Email">Students</span></a>
                </li>
                <li class=" nav-item"><a href="app-chat.html"><i class="fa fa-pagelines"></i><span class="menu-title" data-i18n="Chat">Subjects</span></a>
                </li>
